...
namespace XCare.DMS.Message
{
    public abstract class BusConfig
    {
        ...
        public abstract Action<IRabbitMqBusFactoryConfigurator, IRabbitMqHost> SetReceiveEndPointHandle { get; }
        ...
        public virtual IBusControl CreateBus()
        {
            var bus = Bus.Factory.CreateUsingRabbitMq(cfg =>
            {
                ...
                SetReceiveEndPointHandle.Invoke(cfg, host);
            });
            bus.Start();
            return bus;
        }
